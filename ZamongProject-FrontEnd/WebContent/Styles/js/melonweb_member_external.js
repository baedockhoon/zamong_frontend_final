...
function getMemberNickName() {
	var strBuf = unescape(decodeURIComponent(Base64.decode(getCookie("MUNIK"))));
...
function getMUGHeaderCookie(Name) {
	...
	var cookieNameArray = new Array();
	var strBuf = unescape(decodeURIComponent(Base64.decode(getCookie("MUG"))));
...
function getMUACHeaderCookie(Name) {
    var cookieNameArray = new Array();
    var strBuf = unescape(decodeURI(Base64.decode(getCookie('MUAC'))));
    if (strBuf == null) return null;
...
function niceAuthPop(viewType,isReload,callback,removeCallback,isForcePop,isContentType,encMemberId,cpId){
	var httpMemberDomain = httpMemberDomain!=undefined?httpMemberDomain:"http://member.melon.com";
	var arrayDomain = domainInfo();
	var sslMemberDomain = arrayDomain[1];
	if(sslMemberDomain==undefined){
		sslMemberDomain = "https://member.melon.com";
...
var MemberCommFunc = {
	memberAuthPop : function(encMemberId,cpId){
		...
		var width = 600;
		var height = 674;
		var url = MemberEtc.changeUrl("/muid/web/popup/memberauth_inform.htm");
		...
		if(objectId!=undefined && objectId!=''){
		    ...
		    if (headerLayout == null) {
		    	...
		    	if(pageCode=='LOGIN' || pageCode=='EMAILRECEIVECANCEL'){
					...
					headerLayout.innerHTML += "				<li class='first_child'><a href='http://www.melon.com/chart/index.htm' class='main_menu menu01' title='멜론차트'><span>멜론차트</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='http://www.melon.com/new/index.htm' class='main_menu menu02' title='최신음악'><span>최신음악</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='http://www.melon.com/genre/song_list.htm?classicMenuId=DP0100' class='main_menu menu03' title='장르음악'><span>장르음악</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='http://www.melon.com/dj/today/djtoday_list.htm' class='main_menu menu04' title='멜론DJ'><span>멜론DJ</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='http://www.melon.com/tv/index.htm' class='main_menu menu05' title='멜론TV'><span>멜론TV</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='http://www.melon.com/artistplus/todayupdate/index.htm' class='main_menu menu06' title='스타포스트'><span>스타포스트</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='http://www.melon.com/musicstory/today/index.htm' class='main_menu menu07' title='뮤직스토리'><span>뮤직스토리</span></a></li>";
					...
					headerLayout.innerHTML += "						<ul>";
					headerLayout.innerHTML += "							<li class=''><a href='http://www.melon.com/smartradio/index.htm' title='스마트라디오'><span class='menu_more m1'>스마트라디오</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='http://www.melon.com/flac/index.htm' title='원음전용관'><span class='menu_more m2'>원음전용관</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='http://www.melon.com/edu/index.htm' title='어학'><span class='menu_more m3'>어학</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='http://www.melon.com/customer/announce/index.htm' title='공지사항'><span class='menu_more m4'>공지사항</span></a></li>";
					headerLayout.innerHTML += "						</ul>";
					headerLayout.innerHTML += "						<ul>";
					headerLayout.innerHTML += "							<li class=''><a href='http://www.melon.com/commerce/pamphlet/web/sale_listMainView.htm' title='이용권구매'><span class='menu_more m9'>이용권구매</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='javascript:goMyPageAddCash();' title='멜론캐쉬충전'><span class='menu_more m6'>멜론캐쉬충전</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='http://www.melon.com/event/index.htm' title='이벤트'><span class='menu_more m7'>이벤트</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='http://faqs2.melon.com/customer/index.htm' title='고객센터'><span class='menu_more m8'>고객센터</span></a></li>";
					headerLayout.innerHTML += "						</ul>";
					headerLayout.innerHTML += "					</div>";
					...
					if(isMelonLogin()){
						...
						headerLayout.innerHTML += "<a href='https://member.melon.com/muid/web/help/myinfointro_inform.htm'>"+getDisplayId()+"</a></span> 님</span>";
			...
			document.write("								<a href='http://www.melon.com/chart/index.htm' class='menu01' title='멜론차트'>멜론차트</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='http://www.melon.com/new/index.htm' class='menu02' title='최신'>최신</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='http://www.melon.com/genre/song_list.htm?classicMenuId=DP0100' class='menu03' title='장르음악'>장르</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='http://www.melon.com/dj/today/djtoday_list.htm' class='menu04' title='멜론DJ'>멜론DJ</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='http://www.melon.com/tv/index.htm' class='menu05' title='멜론TV'>멜론TV</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='http://www.melon.com/artistplus/todayupdate/index.htm' class='menu06' title='스타포스트'>스타포스트</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='http://www.melon.com/musicstory/today/index.htm' class='menu07' title='매거진'>매거진</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='http://www.melon.com/melonaward/timeline.htm' class='menu08' title='뮤직어워드'>뮤직어워드</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='http://www.melon.com/flac/index.htm' class='menu09' title='멜론Hi-Fi'>멜론Hi-Fi</a>");
			document.write("							</li>");
			document.write("						</ul>");
			document.write("					</div>");
			document.write("				</div>");
			...
			if(isMelonLogin()){
				...
				document.write("<a href='https://member.melon.com/muid/web/help/myinfointro_inform.htm'>"+getDisplayId()+"</a></span> 님</span>");
				if (fromMPS == null || fromMPS.indexOf("MELONPLAYER") < 0) {
			...
			document.write("					<li class='"+(pageCode=='MYINFO2' ? "on":"")+"'><a href=\"javascript:MemberEtc.goPage('MYINFOPROTECT');\" title='내 정보 보호'><span class='m_menu m2'>내 정보 보호</span></a></li>");
			document.write("					<li class='"+(pageCode=='MYINFO4' ? "on":"")+"'><a href=\"javascript:MemberEtc.goPage('GRADE_INFO');\" title='내 등급'><span class='m_menu m9'>내 등급</span></a></li>");
			document.write("					<li class='"+(pageCode=='PRODUCTCENTER' ? "on":"")+"'><a href=\"javascript:MemberEtc.goPage('PRODUCTCENTER');\" title='내 이용권/결제정보 '><span class='m_menu m8'>내 이용권/결제정보</span></a></li>");
			document.write("					<li class='"+(pageCode=='ENTEREVENT' ? "on":"")+"'><a href=\"javascript:MemberEtc.goPage('ENTEREVENT');\" title='이벤트 응모내역'><span class='m_menu m5'>이벤트 응모내역</span></a></li>");
			document.write("				</ul>");
			document.write("			</div>");
			document.write("		</div>");
			document.write("	</div>");
...
//			document.write("			</ul>");
			...
			document.write("				<li class='menu05'><a title='멜론 플레이어 - 페이지 이동' class='menu01 mlog' href='http://www.melon.com/customer/serviceintro/index.htm'><span>멜론플레이어</span></a></li>");
			document.write("				<li class='menu06'><a title='멜론모바일 - 페이지 이동' class='menu02 mlog' href='http://www.melon.com/customer/serviceintro/multi_mobile_smart.htm'><span>멜론모바일</span></a></li>");
			document.write("				<li class='menu07'><a href='http://faqs2.melon.com/customer/index.htm' title='고객센터'><span>고객센터</span></a></li>");
			document.write("			</ul>");
			document.write("		</div>");
			document.write("		<ul class='footer_policy clfix'>");
			document.write("			<li class='first_child'><a href='http://www.iloen.com/' title='회사소개 ' target='_blank'>회사소개</a></li>");
			document.write("			<li><a href='http://info.melon.com/terms/web/terms1_1.html' title='이용약관 ' target='_blank'>이용약관</a></li>");
			document.write("			<li><a href='http://info.melon.com/terms/web/terms3.html' title='개인정보처리방침 ' target='_blank'><strong>개인정보처리방침</strong></a></li>");
			document.write("			<li><a href='http://info.melon.com/terms/web/terms5_1.html' title='청소년보호정책 ' target='_blank'>청소년보호정책</a></li>");
			document.write("			<li><a href='http://faqs2.melon.com/customer/faq/informFaq.htm?no=1&amp;faqId=QUES20140616000001&amp;SEARCH_KEY=&amp;SEARCH_PAR_CATEGORY=CATE20130909000006&amp;SEARCH_CATEGORY=CATE20130909000021' title='제휴/프로모션문의 '>제휴/프로모션문의</a></li>");
			document.write("			<li><a href=\"javascript:MemberEtc.goPage('EMAIL_COL_REJECT',1,384,331);\" title='이메일주소무단수집거부 '>이메일주소무단수집거부</a></li>");
			document.write("			<li><a href='http://partner.melon.com' title='파트너센터 ' target='_blank'>파트너센터</a></li>");
			document.write("			<li class='last_child'><a href='http://www.ftc.go.kr/info/bizinfo/communicationView.jsp?apv_perm_no=2011322016230202008&area1=&area2=&currpage=2&searchKey=01&searchVal=%EB%A1%9C%EC%97%94&stdate=&endate=' class='btn-info' title='사업자정보확인 ' target='_blank'>사업자정보확인</a></li>");
			document.write("		</ul>");
			document.write("		<p>");
			document.write("			<span class='first'>서울시 강남구 테헤란로 103길 17</span><span>대표이사 신원수, 박성훈</span><span>사업자등록번호 138-81-05876</span><span>통신판매업 신고번호 제2011-서울강남-02008호</span><br /><span class='first'>문의전화(평일 09:00~18:00) 1566-7727 (유료)</span><span>이메일 : <a href='http://helpdesk.melon.com/customer/help/helpForm.htm?type=' class='btn_footer_mail' title='1:1문의하기' target='_blank'>meloninformation@iloen.com</a></span><span>© 2016. LOEN Entertainment, Inc. ALL RGIHTS RESERVED.</span>");
			document.write("		</p>");
...
//	         xy =  1+km
	...
	var AuthRSA = function( success, fail ) {
		this.running = null;
		this.url = "/muid/web/authentication/authentication_getRSAPublic.json";
