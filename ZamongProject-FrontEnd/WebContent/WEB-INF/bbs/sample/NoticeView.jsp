...
<head>
	...
	<meta property="og:url" content="http://www.melon.com/customer/announce/infomAnnounce.htm?seq=555&sIndex=1&classify=&schText=&no=330&maxNo=330"/>
    ...
    <link rel="stylesheet" href="http://cdnimg.melon.co.kr/static/web/resource/style/w1/qd/e/uolshpokn9.css" type="text/css" /> 
			...
			<link rel="stylesheet" href="/resource/style/web/customer/melonweb_customer.css" type="text/css" />
...
<!-- contents -->
			<div id="conts">
				...
				<div class="wrap_tab03 type05">
					...
					<li class="on"><a href="NoticeList.do" class="link_tab" title="공지사항 - 페이지 이동">
					...
					<table border="1" style="width:100%">
						...
						<thead>
							<tr>
									...
									<th scope="col" class="th02"><div class="wrap">${dto.nt_no }</div></th>
								

								<th scope="col" class="th02"><div class="wrap">${dto.nt_classification}</div></th>
								<!-- 140521_수정 -->
								<th scope="col" class="t_left fc_strong"><div class="wrap subject_type">${dto.nt_title}</div></th>
								<!-- //140521_수정 -->
								<th scope="col" class="th02"><div class="wrap">${dto.nt_hitcount}</div></th>
								<th scope="col" class="th02"><div class="wrap">${dto.nt_regidate}</div></th>
							</tr>
						</thead>
						<tbody>
					...
					<li>
						<dl>
							<dt class="next">다음</dt>
								...
								<dd class="title">안내</dd>
								<dd><a href="javascript:goDetail('1','554')" class="ellipsis" title="다음 페이지로 이동">롯데카드 전산작업 안내</a></dd>
...
<!-- //contents -->
		<form id="dataForm" method="get">
			...
			<input type="hidden" name="maxNo" value="330">
		</form>
	<!-- 전체 공통 스크립트 -->
