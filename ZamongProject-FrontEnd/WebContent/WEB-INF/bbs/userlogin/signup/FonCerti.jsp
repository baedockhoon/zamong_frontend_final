...
<link rel="stylesheet" href="https://cdnimg.melon.co.kr/static/member/resource/style/me1/9d/i/uo3devx9uj.css" type="text/css" />
...
<script type="text/javascript" src="https://cdnimg.melon.co.kr/static/member/resource/script/me1/qb/f/1y11awuvhbx.js"></script>
<script type="text/javascript" src="https://cdnimg.melon.co.kr/static/member/resource/script/me1/7h/v/1o7ul7h9xd9.js"></script>
<script type="text/javascript" src="https://cdnimg.melon.co.kr/static/member/resource/script/me1/f9/m/1y35dxk43qt.js"></script>
		...
		<div id="conts_section">
			<div class="box_mem_info">
				...
				<div class="mem_info_cont d_join_tab_cont">
		        	...
		        	<input type="hidden" 	id="joinSeq"		name="joinSeq" 			value="YhNGhCzDKWF+/0LHXnHZBQ=="/>
	        		<input type="hidden"	name="isAgreeCk"	value="N"/>
		   	     	<input type="hidden"	name="isAgreeCk"	value="N"/>
		        	<input type="hidden"	name="isAgreeCk"	value="N"/>
					<input type="hidden"	id="eventRcvYn"		name="eventRcvYn"		value=""/>
					<input type="hidden"	id="melTmAgree"		name="melTmAgree"		value=""/>
		        	<input type="hidden"	id="certType"		name="certType"			value="2"/>
		        	<input type="hidden" 	id="isBanWordName"	name="isBanWordName"	value=""/>
					<input type="hidden"	id="isDup"			name="isDup"			class="auth"	value=""/>
		        	<input type="hidden"	id="isSmsSend"		name="isSmsSend"		class="auth"	value=""/>
		        	<input type="hidden"	id="smsAuthKey"		name="smsAuthKey"		class="auth"	value=""/>
		        	<input type="hidden"	id="authPhone"		name="authPhone"		class="auth"	value=""/>
		        	<input type="hidden"	id="ocLimit"		name="ocLimit"			class="auth"	value=""/>
		        	<input type="hidden"	id="isEmailSend"	name="isEmailSend"		class="auth"	value=""/>
		        	<input type="hidden"	id="emailAuthKey"	name="emailAuthKey"		class="auth"	value=""/>
		        	<input type="hidden"	id="authEmail"		name="authEmail"		class="auth"	value=""/>
		        	<input type="hidden"	id="sendTime"		name="sendTime"			class="auth"	value=""/>
		        	<input type="hidden" 	id="sendError"		name="sendError"		class="auth"	value=""/>
		        	<input type="hidden" 	id="reToken"		name="reToken"			value=""/>

					<div class="wrap_tab_select d_join_tab">
						<ul>
							<li class="first_child on"><a href="#joinPhone"><span class="cntt">휴대폰 인증 가입</span></a></li>
							<li class="last_child"><a href="#joinEmail"><span class="cntt">이메일 인증 가입</span></a></li>
						</ul>
					</div>
					<!--휴대폰 인증 가입-->
					<div id="joinPhone" class="join_phone_certification d_join_cont">
						...
						<div class="tb_list03 mt6">
							<table border="1" style="width:100%">
								<caption>이 표는 회원가입을 위한 정보입력 리스트로 휴대폰번호, 이름 내용을 포함하고 있습니다.</caption>
								<colgroup>
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="wrap">
												<div id="tn_tr" name="tn_tr" class="wrap_input_info04 d_input_write" style="width:310px;">
													<div class="wrap_input">
														<input type="text" id="tn" name="tn" title="휴대폰번호 입력 편집창" placeholder="휴대폰번호 입력" class="text53" style="width:255px;" maxlength="11" />
													</div>
												...
												<div class="otherJoin" style="display:none;">
													<div id="tn_other" class="wrap_btn_c mt10">
														<button type="button" class="btn_round_green46" onclick="MemberEtc.goPage('LOGIN');"><span class="odd_span"><span class="even_span"></span></span></button>
													</div>
													<div  id="tn_otherjoin" class="wrap_btn_c mt16">
														<button type="button" class="btn_round_gray46"><span class="odd_span"><span class="even_span">다른 휴대폰번호로 가입</span></span></button> 
													</div>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="wrap">
												<div id="tnName_tr" name="tnName_tr" class="wrap_input_info04 d_input_write" style="width:310px;">
													<div class="wrap_input">
														<input id="tnName" name="tnName" type="text" title="이름 입력 편집창" placeholder="이름 입력 (2자 이상)" class="text53" style="width:255px;" />
													</div>
													<div class="wrap_input_check">
														<a href="#" class="btn_input_check d_input_del" style="display:none;">삭제</a>
													</div>
												</div>
			                 					<p id="tnName_msg" class="txt_error" style="display:none;"></p>
											</div>
										</td>
									</tr>
								</tbody>
					...
					<!--이메일 인증 가입-->
					<div id="joinEmail" class="join_email_certification d_join_cont" style="display:none;">
						<p class="txt_info mt27">입력한 이메일로 인증 후 회원가입 됩니다.</p>

						<div class="tb_list03 mt6">
							<table border="1" style="width:100%">
								<caption>이 표는 회원가입을 위한 정보입력 리스트로 이메일 주소, 이름 내용을 포함하고 있습니다.</caption>
								<colgroup>
								...
								<tbody>
										...
										<td>
											<div class="wrap">
												<div class="box_email_input">
													<div id="email_tr" name="email_tr" class="wrap_input_info04 d_input_write" style="width:170px">
														<div class="wrap_input">
															<input type="text" id="email" name="email" title="이메일 입력 편집창" placeholder="이메일 입력" class="text53" style="width:115px;" />
														</div>
														<div class="wrap_input_check">
															<a href="#" class="btn_input_check d_input_del" style="display:none;">삭제</a>
														</div>
													...
													<div id="mailDomain_tr" class="select_wrap">
														<select id="mailDomain" name="mailDomain" title="연락처 정보 선택" style="width: 95px; height: 31px; display: none;" class="d_selectbox2" data-class="select_type04" data-type="email">
												...
												<p id="email_msg" class="txt_error" style="display:none;"></p>
												<div class="otherJoin" style="display:none;">
													<div id="email_other" class="wrap_btn_c mt10">
														<button type="button" class="btn_round_green46" onclick="MemberEtc.goPage('LOGIN');"><span class="odd_span"><span class="even_span"></span></span></button>
													</div>
													<div id="email_otherjoin"class="wrap_btn_c mt16">
														<button type="button" class="btn_round_gray46"><span class="odd_span"><span class="even_span">다른 이메일로 가입</span></span></button>
													</div>
													<p id="email_othermsg" class="txt_error">멜론은 이메일 중복가입이 불가능합니다.<br>해당 이메일로 가입을 원하시면 고객센터로 문의해 주세요.</p>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div class="wrap">
												<div id="emailName_tr" name="emailName_tr" class="wrap_input_info04 d_input_write" style="width:331px;">
													<div class="wrap_input">
														<input id="emailName" name="emailName" type="text" title="이름 입력 편집창" placeholder="이름 입력 (2자 이상)" class="text53" style="width:275px;" />
													</div>
													<div class="wrap_input_check">
														<a href="#" class="btn_input_check d_input_del" style="display:none;">삭제</a>
													</div>
												</div>
												<p id="emailName_msg" class="txt_error" style="display:none;"></p>
											</div>
										</td>
									</tr>
									<tr>
										<th scope="row">
											<div class="wrap" style="padding-top: 37px; letter-spacing: -2px;">
												자동등록방지
											</div>
										</th>
										<td>
				...
				<div class="mem_info_cont type_border mt34 d_input_all_cont">
					<div class="box_join_clause box_check_all">
						<div class="box_check d_input_check d_input_all">
		                    ...
		                    <label for="clauseAgree" class="label_check"><span class="icon"></span>전체동의<em>(선택사항 포함)</em></label>
		                </div>
					</div>
					<div class="box_join_clause first_child">
						<div class="box_check d_input_check">
		                    <input type="checkbox" id="clauseAgree1" name="agreeCk" class="input_check" />
		                    <label for="clauseAgree1" class="label_check"><span class="icon"></span>이용약관<em class="point">(필수)</em></label>
		                    <a href="#" class="btn_more"><span>약관 보기</span></a>
		                </div>
						...
						<div class="box_clause_info">
							...
							<div class="wrapper">
						        <h3 class="tit_rule"><strong>1. 이용신청의 승낙 및 제한(약관 제7조, 제8조)</strong></h3>
						        <ul class="txt_rule">
						        ...
						        <h3 class="tit_rule"><strong>2. 서비스 이용(약관 제13조, 제15조, 제17조)</strong></h3>
						        <ul class="txt_rule">
						        ...
						        <h3 class="tit_rule"><strong>3. 계약해지 및 이용제한(약관 제25조)</strong></h3>
						        <ul class="txt_rule">
						            <li>- 서비스 이용계약을 해지하고자 할 경우 본인이 서비스 사이트 상 또는 전화 등 회사가 제공하는 방법으로 해지신청을 해야 함. 회사는 회원의 유료서비스 청약철회, 환불, 계약의 해지와 관련 회사의 “멜론 유료서비스약관”에 그 절차 및 제반 사항을 안내함.</li>
		                ...
		                <a href="#" onclick="termsPopup('useTerm');return false;" class="btn_more_all">전문보기</a>
					</div>
					<div class="box_join_clause">
						<div class="box_check d_input_check">
		                    <input type="checkbox" id="clauseAgree2" name="agreeCk" class="input_check" />
		                    <label for="clauseAgree2" class="label_check"><span class="icon"></span>유료서비스약관<em class="point">(필수)</em></label>
		                    <a href="#" class="btn_more"><span>약관 보기</span></a>
		                </div>
						...
						<div class="box_clause_info">
							...
							<div class="wrapper">
						        <h3 class="tit_rule"><strong>1. 회원의 유료서비스 예약 변경, 즉시 변경 등(약관 제16조)</strong></h3>
						        <ul class="txt_rule">
						        ...
						        <h3 class="tit_rule"><strong>2. 청약 철회 및 서비스 이용계약의 해제ㆍ해지(약관 제17조)</strong></h3>
						        <ul class="txt_rule">
						        ...
						        <h3 class="tit_rule"><strong>3. 유료서비스의 정지, 중단(약관 제19조)</strong></h3>
						        <ul class="txt_rule">
		                ...
		                <a href="#" onclick="termsPopup('payTerm');return false;" class="btn_more_all">전문보기</a>
					</div>
					<div class="box_join_clause">
						<div class="box_check d_input_check">
		                    <input type="checkbox" id="clauseAgree3" name="agreeCk" class="input_check" />
		                    <label for="clauseAgree3" class="label_check"><span class="icon"></span>개인정보 수집 및 이용<em class="point">(필수)</em></label>
		                    <a href="#" class="btn_more"><span>약관 보기</span></a>
		                </div>
						...
						<div class="box_clause_info">
							...
							<div class="wrapper">
						        ...
						        <p class="txt_rule"><strong>회사는 멜론 서비스의 본질적인 기능 수행 및 업무 처리를 위해 반드시 필요한 정보(필수정보)와 회원의 기호와 필요에 따른 서비스를 제공하기 위해 추가적으로 제공이 요구되는 정보(선택정보)를 구분하여 수집&middot;이용하며, 개별 서비스 이용과정에서 추가 수집이 필요한 경우 별도로 동의를 얻어 수집&middot;이용합니다.</strong></p>
						        <p class="txt_rule">회사는 사상 및 신조, 출신지 및 본적지, 정치적 성향 및 건강상태 등 회원의 기본적 인권을 현저하게 침해할 우려가 있는 개인정보를 수집하지 않습니다. 다만, 회원 또는 제3자가 이미 외부 서비스 내지 연계 서비스를 통하여 불특정 다수에게 직접 공개하였거나, 멜론 서비스 내에서 공개한 정보인 경우에는 처리할 수 있습니다.</p>
						        <p class="txt_rule"><strong>멜론 서비스 제공을 위해서 반드시 필요한 최소한의 개인정보이므로 동의를 해 주셔야 서비스를 이용하실 수 있습니다.</strong></p>
						        <p class="txt_rule"><strong>&lt;회원 가입 단계&gt;</strong></p>
						        <ul class="txt_rule">
						            <li>- 회원입력정보</li>
						        </ul>
						        <table class="txt_rule">
						            ...
						            <tbody>
						                <tr>
						                    <td>이름, 생년월일, 아이디, 비밀번호, 이메일, 닉네임, (휴대전화 인증시)휴대전화번호, 성별, 만 14세 미만 아동의 경우, 법정대리인 정보(법정대리인명, 휴대전화번호, 이메일, 법정대리인 암호화된 동일인 식별정보(CI))</td>
						                    <td rowspan="2">
						                        ①회원제서비스 운영 및 관리(가입 의사&middot;나이, 자격 확인&middot;제한 준수, 가입 및 탈퇴 처리 등)<br>
						                        ②이용약관&middot;서비스상품약관&middot;개인정보처리방침의 변경, 서비스 변경&middot;중단&middot;장애&middot;침해사고 등 중요사항 고지 등 의사소통 경로<br>
						                        ③서비스 민원사항&middot;고충 처리, 결과 안내<br>
						                        ④저작권법, 정보통신망법, 청소년보호법 등 비롯한 서비스 관련 제반 법령 위반 행위, 기타 회사 및 타 회원의 권리를 침해하는 서비스 부정이용행위 제재 등<br>
						                        ⑤개인정보 보호 관련 법령에 따른 회원의 정보 열람, 정정권 이행<br>
						                        ⑥정보통신망법 등 관련 법령에 따른 보유 및 보존의무 이행
						                    </td>
						                </tr>
						                <tr>
						                    <td>
						                        카카오계정 연결시 : 카카오 프로필 정보(닉네임/프로필 사진), 이메일
						                    </td>
						                </tr>
						            </tbody>
						        </table>
						
						        <p class="txt_rule"><strong>&lt;서비스 이용 단계&gt;</strong></p>
						        <ul class="txt_rule">
						            <li>- 회원입력정보</li>
						        </ul>
						        <table class="txt_rule">
						            ...
						            <tbody>
						                <tr>
						                    <td>휴대전화&middot;i-PIN 본인인증 선택시: 이름, 생년월일, 성별, 내/외국인 여부, 중복가입확인정보(DI), 암호화된 동일인 식별정보(CI)</td>
						                    <td>일부 콘텐츠 및 서비스 이용, 금융거래 시 관련 법령에 따른 나이 또는 본인 확인</td>
						                </tr>
						                <tr>
						                    <td>법정대리인의 정보(법정대리인명, 휴대전화번호, 이메일, 법정대리인 암호화된 동일인 식별정보(CI))</td>
						                ...
						                <tr>
						                    <td>○결제수단별 정보<br>
						                        <ul class="txt_rule">
						                            ...
						                            <li>: 카드번호(SKT T멤버쉽카드, 오케이캐쉬백카드(OCB)), 휴대전화번호,OCB비밀번호, 성별, 생년월일, 단말정보(모델명, 단말기고유번호,  개통일), 데이터 함께쓰기 요금제 사용 여부</li>
						                        </ul>
						                    </td>
						                    <td>
						                        ①유료서비스 계약의 이행 및 서비스 제공에 따른 요금 청구&middot;결제&middot;정산&middot;할인<br>
						                        ②관련 법령에 따른 보존 및 제공 의무 이행<br>
						                        ③유료서비스 계약 이행 업무 위탁<br>
						                        (※구매&middot;결제단계에서 회원이 입력하는 신용카드사명, 신용카드 번호, 유효기간, 휴대번호, 상품권번호 등의 정보는 회사가 직접 저장하지 않습니다.)
						                    </td>
						                </tr>
						                <tr>
						                    <td>구매자 이름, 구매자 연락처(휴대전화번호, 이메일), 수령인 이름, 수령인 연락처(휴대전화번호, 유선전화번호), 배송지 주소, (팬클럽 가입상품 구매시)포털 아이디, 생년월일</td><!-- 2016_03_18 변경 -->
						                ...
						                <tr>
						                    <td>이름, 아이디, 닉네임, 휴대전화번호, 법정대리인정보, 단말정보, 가입통신사 정보, 은행계좌정보, 신용카드정보 등</td>
						                    <td>서비스 이용관련 문의&middot;상담&middot;환불&middot;장애 대응 등 민원처리</td>
						                </tr>
						                <tr>
						                ...
						                <tr>
						                    <td>이름, 아이디, 닉네임, 휴대전화번호, 유선전화번호, 주소, 이메일, 성별, 생년월일, 배송지 주소 등</td>
						                    <td>
						                        ①온&middot;오프라인 이벤트&middot;행사 진행, 당첨자 추첨<br>
						                        ②이벤트 당첨자에 대한 경품 배송 <br>
						                        ③위 ①, ②업무의 위탁 또는 제3자 제공<br>
						                        (당첨자 추첨 시까지 최소한의 개인정보만을 이용하며, 이벤트 등 안내시 반드시 사전 고지 및 동의를 구합니다.)
						                    </td>
						                </tr>
						            </tbody>
						        </table>
						        ...
						        <table class="txt_rule">
						            ...
						            <tbody>
						                <tr>
						                    <td>회원의 기기정보 :사용기기별(PC∙휴대전화∙스마트폰∙Tablet∙MP3 Player) 모델명, 단말기고유번호, 휴대전화번호</td>
						                    <td>
						                        ①서비스 부정사용 방지<br>
						                        ②저작권법 및 동법 하위 규정 준수<br>
						                ...
						                <tr>
						                    ...
						                    <td>
						                        ①서비스 이용 내역 확인<br>
						                        ②관련 법령 및 서비스이용약관, 세부 이용가이드 등에서 명시적으로 금지하는 불법행위 및 부정이용행위 제재<br>
						                        ③관련 법령에 따른 보유 및 정보 제공 의무 이행<br>
						                        ④접속빈도 분석, 고객 맞춤형 서비스 제공을 위한 통계 활용<br>⑤원활한 서비스 제공을 위한 서비스 시스템 인프라 확충
						                    </td>
						                </tr>
						            </tbody>
						        </table>
						        <h2 class="tit_rule"><strong>◆ 수집하는 개인정보의 보유 및 이용기간</strong></h2>
						        <p class="txt_rule">회원 탈퇴, 개인정보의 수집 및 이용목적이 달성된 경우 회원의 개인정보를 지체 없이 파기합니다. 단, 아래 각 사유 및 기간에 한하여 예외적으로 회원의 개인정보를 보유합니다.</p>
						
						        <h3 class="tit_rule"><strong>1. 회사 내부 방침에 의한 경우</strong></h3>
						        <p class="txt_rule">불량이용자의 재가입&middot;부정이용 방지, 미납요금의 청구, 기타 민원 대응</p>
						        <ul class="txt_rule">
						            <li>
						                - 보유기간 : 회원 탈퇴 후 6개월간<br>
						                (단, 미납 요금청구의 경우 완납시, 민원 대응의 경우 민원 해결시까지)
						            </li>
						            <li>
						                - 보유정보 : 아이디, 이메일, 휴대전화번호, 중복가입확인정보(DI), 가입일, 탈퇴일
						            </li>
						        </ul>
						
						        <h3 class="tit_rule"><strong>2. 회원이 직접 보존을 요청한 경우 또는 회사가 개별적으로 회원의 동의를 얻은 경우</strong></h3>
						        <ul class="txt_rule">
						            <li>- 보유기간 및 보유정보 : 회원의 요청 또는 동의를 얻은 항목에 대하여 해당 기간 동안 보유</li>
						        </ul>
						
						        <h3 class="tit_rule"><strong>3. 법령에 의거, 이용자의 동의 없이 보존할 것을 정한 경우</strong></h3>
						        <p class="txt_rule"><strong>&lt;보존기간 : 5년&gt;</strong></p>
						        <table class="txt_rule">
						            <thead>
						                <tr>
						        ...
						        <p class="txt_rule"><strong>&lt;보존기간 : 3년&gt;</strong></p>
						        <table class="txt_rule">
						            <thead>
						                <tr>
						                    <th><strong>근거법령</strong></th>
						        ...
						        <p class="txt_rule"><strong>&lt;보존기간 : 6개월&gt;</strong></p>
						        <table class="txt_rule">
						            <thead>
						                <tr>
						                    <th>근거법령</th>
						        ...
						        <h3 class="tit_rule"><strong>4. 개인정보 유효기간제의 적용</strong></h3>
						        <p class="txt_rule">회사는 회원이 일정기간(1년)동안 서비스를 이용한 사실 또는 활동한 기록이 없는 경우, 개인정보의 안전한 보호 및 피해 발생을 방지하기 위해 이용자에게 사전통지하고 개인정보를 별도로 분리하여 저장 관리합니다.<br>개인정보유효기간제에 의해 별도 분리된 경우라도 회원이 서비스 재이용을 원하실 경우에는, 본인확인 절차를 거쳐 서비스를 재이용하실 수 있습니다.</p>
						    </div>
							</div>
							<!--//개인정보 수집 및 이용-->
						</div>
		                <a href="#" onclick="termsPopup('privateTerm');return false;" class="btn_more_all">전문보기</a>
					</div>
					<div class="box_join_clause">
						<div class="box_check d_input_check">
		                    <input type="checkbox" id="clauseAgree4" name="agreeCk" class="input_check" />
		                    <label for="clauseAgree4" class="label_check"><span class="icon"></span>이벤트, 서비스안내 수신<em>(선택)</em></label>
		                    <a href="#" class="btn_more"><span>약관 보기</span></a>
		                </div>
						<div class="box_clause_info">
							<!-- 멜론 이벤트,서비스안내 수신 -->
							...
							<div class="wrapper">
						       <style>
						        ...
						        <p class="txt_rule"><strong>선택항목의 경우, 동의하지 않으셔도 서비스 이용이 가능합니다.</strong></p>
						        <table class="txt_rule">
						            <thead>
						                <tr>
						                    <th><strong>수집&middot;이용 항목</strong></th>
						            ...
						            <tbody>
						                <tr>
						                    <td>휴대전화번호, 이메일</td>
						                    <td>
						                        ①이벤트&middot;신규/개편 상품&middot;서비스 안내&middot;고지 등 홍보&middot;마케팅 활용<br>
						                        ②신규서비스 개발 및 고객 서비스 개선 의견 반영
						                    </td>
						                </tr>
						            </tbody>
						        </table>
				...
				<div class="wrap_btn_c mt34">
					<a href="#" onclick="joinStep();" class="btn btn_square_green66">다음 단계</a>
				</div>
